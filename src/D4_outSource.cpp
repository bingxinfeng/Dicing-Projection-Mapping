...
//--------------------------------------------------------------
void D4_outSource::setName(string _name){
    name = _name;
}

//--------------------------------------------------------------
// Don't do any drawing here
void D4_outSource::update(){
    imageOutUpdate();
...
//==============================================================
void D4_outSource::imageOutSetup(){
    tileNum = 10;
    spacing = w/tileNum;
    tOut = 280; //move from 280
}
//--------------------------------------------------------------
void D4_outSource::imageOutUpdate(){
