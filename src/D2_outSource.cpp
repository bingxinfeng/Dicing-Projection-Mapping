...
//--------------------------------------------------------------
void D2_outSource::setName(string _name){
    name = _name;
}

//--------------------------------------------------------------
// Don't do any drawing here
void D2_outSource::update(){
    imageOutUpdate();
...
//==============================================================
void D2_outSource::imageOutSetup(){
    tileNum = 10;
    spacing = w/tileNum;
    tOut = 280; //move from 280
}
//--------------------------------------------------------------
void D2_outSource::imageOutUpdate(){
    tOut+=0.5;
    if(tOut>=400){
        tOut=400;
    }
