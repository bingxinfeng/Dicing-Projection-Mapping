...
//--------------------------------------------------------------
void D1_outSource::setName(string _name){
    name = _name;
}

//--------------------------------------------------------------
// Don't do any drawing here
void D1_outSource::update(){
    imageOutUpdate();
...
//==============================================================
void D1_outSource::imageOutSetup(){
    tileNum = 10;
    spacing = w/tileNum;
...
//--------------------------------------------------------------
void D1_outSource::imageOutUpdate(){
    tOut+=0.5;
    if(tOut>=400){
        tOut=400;
    }
