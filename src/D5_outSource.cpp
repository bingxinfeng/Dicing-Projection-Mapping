...
//--------------------------------------------------------------
void D5_outSource::setName(string _name){
    name = _name;
}

//--------------------------------------------------------------
// Don't do any drawing here
void D5_outSource::update(){
    imageOutUpdate();
...
//==============================================================
void D5_outSource::imageOutSetup(){
    tileNum = 10;
    spacing = w/tileNum;
    tOut = 280; //move from 280
}
//--------------------------------------------------------------
void D5_outSource::imageOutUpdate(){
    tOut+=0.5;
    if(tOut>=400){
        tOut=400;
    }
